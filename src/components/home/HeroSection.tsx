...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20">
      <GridBackground />
      <HeroNetwork />
      <GlowOrb className="top-1/4 -left-32" color="cyan" size="lg" />
      <GlowOrb className="bottom-1/4 -right-32" color="purple" size="lg" />
      <GlowOrb className="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" color="blue" size="md" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <span>Đối tác công nghệ cao cấp tại Việt Nam</span>
          </motion.div>
          ...
          >
            Công nghệ{" "}
            <span className="gradient-text">thúc đẩy</span>
            <br />
          ...
          >
            Xây dựng hệ thống số hiệu năng cao — phần mềm tùy chỉnh, website cao cấp,
            SEO và giải pháp AI cho doanh nghiệp Việt Nam.
          </motion.p>
          ...
          >
            {[
              ...
              <div key={stat.label} className="text-center">
                <motion.div className="font-display text-2xl sm:text-3xl font-bold gradient-text">
                  {stat.value}
                </motion.div>
